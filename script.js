...
const feedbackMessages = {
  part01: {
    ...
    a2: "<h2>Feedback</h2><p><span>Hold your horses.</span><br /><span> Remember to follow the process because if you send the equipment off without completing a visual inspection or determining the MEL, you could cost your unit and the Army a lot of money down the line.</span></p>",
    ...
    a3b3: "<h2>Feedback</h2><p><span>It is important to conduct a visual inspection of the equipment, however, before you send the equipment off repair, remember to review the work request in GCSS-A.</span><br /><span> By not having a look at the work order it could cause issues down the line when documenting the repair.</span></p>",
  },
  part02: {
    a1b1: "<h2>Feedback</h2><p><span>Excellent decision to document the equipment, however remember that before you approve the release of the equipment, you must conduct a function check.</span><br /><span> Also remember that every part of the work request should be entered in GCSS-A.</span></p>",
...
// Sending equipment out too early
  3:"<br><span>You've got a really good grasp of what needs to happen as you process a work order. Don't forget to follow every step in the repair process, and don't send the equipment out for repair or back to the customer without completing the process. Sending the equipment out without calculating the MEL, entering information in GCSS-A, or giving the device back to the customer before following each step in the process, could cost someone their life. </span>",
// Mix of 2 and 3
